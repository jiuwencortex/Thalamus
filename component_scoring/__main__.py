# Enables: python -m component_scoring [build] --type skills|memory|tools
#
# Examples:
#   python -m component_scoring build --type skills \
...
#
#   python -m component_scoring build \
#       --skills-dir ~/.jiuwenswarm/agent/workspace/skills \
#       --matrix-dir ~/.jiuwenswarm/agent/workspace/oracle \
#       --model gpt-4o-mini --api-key $OPENAI_API_KEY
